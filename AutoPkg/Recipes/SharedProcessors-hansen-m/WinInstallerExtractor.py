# Downloaded from https://github.com/autopkg/hansen-m-recipes/blob/de17d7db2537ffa00c27281a392f37fe599efdca/SharedProcessors/WinInstallerExtractor.py
...
class WinInstallerExtractor(Processor):
    ...
    output_variables = {"version": {"required": False, "description": "ProductVersion of exe."}}
