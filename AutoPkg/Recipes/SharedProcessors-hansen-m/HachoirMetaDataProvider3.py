# Downloaded from https://github.com/autopkg/hansen-m-recipes/blob/de17d7db2537ffa00c27281a392f37fe599efdca/SharedProcessors/HachoirMetaDataProvider3.py
...
class HachoirMetaDataProvider3(Processor):
    ...
    input_variables = {
        ...
        "metadata_key": {"required": False, "description": "Metadata key of %file_path% to return the value of"},
        "metadata_index": {"required": False, "description": "Index, if multiple values exist for the %metadata_key%"},
        "output_var_name": {
            "required": False,
            "description": "Output variable, defaults to %metadata_key% or 'version'",
        },
    }
    output_variables = {"output_var_name": {"description": "Output variable, defaults to 'version'"}}
