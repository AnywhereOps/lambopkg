# Downloaded from https://github.com/autopkg/MLBZ521-recipes/blob/8b7738eed4c2f8b6b32a897907ee3420fa0c74ef/Shared Processors/RenamePath.py
...
class RenamePath(Processor):
    ...
    description = __doc__
    input_variables = {
        "source_path": {"required": True, "description": "Full path to a file or directory that needs to be renamed."},
        "new_name": {
            "required": True,
    ...
    output_variables = {"return_variable": {"description": "The variable that the new path was set too."}}
