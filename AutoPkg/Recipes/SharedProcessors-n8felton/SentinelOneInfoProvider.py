# Downloaded from https://github.com/autopkg/n8felton-recipes/blob/646d469b0e6e964e0605774d8541ce29912b9207/SharedProcessors/SentinelOneInfoProvider.py
...
class SentinelOneInfoProvider(URLGetter):
    ...
    input_variables = {
        ...
        "S1_API_TOKEN": {
            "required": True,
            "description": ("API Token generated in the console for your user account."),
        },
        "S1_PACKAGE_STATUS": {
            "required": False,
            "description": (
    ...
    output_variables = {
        "url": {"description": "The full url of the package to download."},
        "filename": {"description": "The filename the downloaded package."},
        "version": {"description": "The version of the software."},
        "sha1": {"description": "A description of the software."},
    }
    ...
    def get_s1_updates(self, s1_pkg_status=None, s1_pkg_version=None):
        ...
        self.output(json.dumps(update_args, sort_keys=True, indent=4, separators=(",", ": ")), 2)
        ...
        self.output(json.dumps(updates_json, sort_keys=True, indent=4, separators=(",", ": ")), 2)
        return updates_json
    ...
    def main(self):
        ...
        updates_json = self.get_s1_updates(self.env.get("S1_PACKAGE_STATUS"), self.env.get("S1_PACKAGE_VERSION"))
        try:
