# Downloaded from https://github.com/autopkg/n8felton-recipes/blob/646d469b0e6e964e0605774d8541ce29912b9207/SharedProcessors/DistributionInfoProvider.py
# Commit: 646d469b0e6e964e0605774d8541ce29912b9207
# Downloaded at: 2025-11-27 22:31:53 UTC
...
class DistributionInfoProvider(Processor):
    "Provides metadata of packages from their 'Distribution' file that may be useful to other processors."
    ...
    input_variables = {
        "unpacked_path": {
            "required": True,
            "description": (
                "The path of the expanded package. Should match destination_path of FlatPkgUnpacker processor."
            ),
        },
    }
    output_variables = {
        "title": {"description": ("Title of the package")},
        "min_os_version": {"description": "Minimum supported OS version"},
        "product_version": {"description": ("The version of the product being installed")},
    }

    def main(self):
        distribution_path = "{}/{}".format(self.env["unpacked_path"], "Distribution")
